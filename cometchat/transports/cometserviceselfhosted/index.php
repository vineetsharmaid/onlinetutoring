...
?>
	...
	<head>
        ...
        <script src="../../js.php?type=transport&name=cometserviceselfhosted" type="text/javascript"></script>
		<script type="text/javascript">
			if(typeof($)=="undefined"){
				$ = jqcc;
			}
		...
		<link type="text/css" href="../../css.php?type=transport&name=cometserviceselfhosted" rel="stylesheet" charset="utf-8">
	</head>
