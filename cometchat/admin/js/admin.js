...
function embed_link(url,width,height) {
	...
	if(module[0]=='chatrooms'){
		if(mod[mod.length-1].indexOf('id=') > -1) {
			...
			var synergyembedscript = '<script src="'+baseUrl+'js.php?type=core&amp;name=embedcode" type="text/javascript"></script>\n<script>var iframeObj = {};iframeObj.module="chatrooms";iframeObj.src="'+baseUrl+'cometchat_embedded.php?crid='+crid+'";iframeObj.width="'+width+'";iframeObj.height="'+height+'";if(typeof(addEmbedIframe)=="function"){addEmbedIframe(iframeObj);}</script>';
			$("#admin-modal-body").html('<textarea class="embedcode_textarea" readonly style="width:100%;height:160px"><div id="cometchat_embed_chatrooms_container" style="display:inline-block; border:1px solid #CCCCCC;"></div>\n'+synergyembedscript+'</textarea>');
		} else {
			var synergyembedscript = '<script src="'+baseUrl+'js.php?type=core&amp;name=embedcode" type="text/javascript"></script>\n<script>var iframeObj = {};iframeObj.module="chatrooms";iframeObj.style="min-height:420px;min-width:300px;";iframeObj.src="'+baseUrl+'cometchat_embedded.php?chatroomsonly=1";iframeObj.width="'+width+'";iframeObj.height="'+height+'";if(typeof(addEmbedIframe)=="function"){addEmbedIframe(iframeObj);}</script>';
			$("#admin-modal-body").html('<textarea readonly style="width:100%;height:140px"><div id="cometchat_embed_chatrooms_container" style="display:inline-block; border:1px solid #CCCCCC;"></div>\n'+synergyembedscript+'</textarea>');
		}
