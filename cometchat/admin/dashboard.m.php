...
function index() {
	...
	if($available_version <= $currentversion){
		$available_version = '';
	}
		...
		<div class="col-sm-12 col-lg-12">
				<div class="card card-inverse card-danger">
					<div class="pb-0" style="padding:16px;">
						<p>Warning: Default administrator username/password detected. Please go to settings and change the username and password.</p>
					</div>
				</div>
			</div>
EOD;
...
EOD;
		...
		<div class="col-sm-6 col-lg-6">
			<div class="card card-inverse card-primary">
				<div class="card-block pb-0">
					<h1 class="mb-0">{$available_version} <span style="position:relative;float:right;">{$button}</span></h1>
