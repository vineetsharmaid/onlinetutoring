...
function index()
{
    ...
    while ($announcement = mysqli_fetch_assoc($query)) {
        ...
        $announcementlist .= '<tr><td style="text-transform: capitalize;">'.htmlspecialchars($announcement['announcement']).'</td><td>'.datify($time)[0].'</td><td align="center"><a style="color:red;" data-toggle="tooltip" title="Delete Announcement" href="?module=announcements&action=deleteannouncement&data='.$announcement['id'].'&amp;ts={$ts}"><i class="fa fa-lg fa-minus-circle"></i></a></td></tr>';
    }
