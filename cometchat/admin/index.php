            ...
            <div class="module form-module">
              <div class="form" >
                ...
                <form method="post" action="?module=dashboard"+currentTime>
                  ...
                  <div class="cometchat_forgotpwd"><a href="https://support.cometchat.com/kb/php/general-queries/forgot-cometchat-administrator-password/" target="_blank">Forgot Password?</a></div>
                </form>
              </div>
            </div>
          </div>
...
function template($auth = 0){
  global $ts, $body, $menuoptions, $module, $navigation, $action;
...
echo <<<EOD
  ...
  <script src="../js.php?admin=1&app=1"></script>
  {$errorjs}
  <script>
