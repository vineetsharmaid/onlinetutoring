        ...
        return {
            ...
            initialize: function(){
                ...
                if(settings.showOnlineTab==1){
                    tabcontent = recenttab+contactstab+groupstab;
                ...
                $("#cometchat_disablelastseen").click(function(event){
                    ...
                    $.cookie(settings.cookiePrefix+"disablelastseen", lastseenflag);
                });
                ...
                var cometchat_tabWidth = jqcc('#cometchat_tabcontainer').width()-2;
                cometchat_tabWidth = (cometchat_tabWidth/tabcount)+'px';
                jqcc('#cometchat_tabcontainer .cometchat_tab').width(cometchat_tabWidth);
            ...
            userStatus: function(item){
                ...
                if(item.lstn == 1){
                    $("#cometchat_disablelastseen").attr("checked", false);
                    $('#cometchat_disablelastseen_label').find('.cometchat_checkindicator').css('display','none');
                    $.cookie(settings.cookiePrefix+"disablelastseen",true);
                }
                        ...
                        if(parseInt(incoming.self)==1 && (!incoming.hasOwnProperty('botid') || (typeof incoming.botid == "undefined" && incoming.botid == 0))){
                           ...
                           if((message.indexOf('<img')==-1 && message.indexOf('src')==-1) || (smileycount > 0 && smileymsg != '')){
                            ...
                            if(message.indexOf('avchat_webaction=initiate')!=-1){
                                jqcc.docked.generateIncomeingAvchatData(incoming,avchat_data,currenttime);
                                ...
                                if(incoming.sent > currenttime - 15){
                                    ...
                                    jqcc.docked.removeAVchatContainer(incoming.from);
                                }
