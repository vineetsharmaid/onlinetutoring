      ...
      <div class="widget no-border">
        <nav>
          <ul class="nav nav-list">
            ...
            <li><a class="tree-toggler nav-header">Find a Tutor <i class="fa fa-angle-down"></i></a>
              <ul class="nav nav-list tree">
                <li><a href="#/">Search for Tutor</a></li>
...
<div id="wrapper">
  ...
  <div class="main-content">
    ...
    <section class="inner-header divider parallax" data-bg-img="<?=base_url()?>assets/img/bg/bg-1.jpg">
      ...
      <a class="logo-center pb-20" href="<?=base_url()?>"><img width="165px" alt="logo" src="<?=base_url()?>assets/img/logo.png"></a>
