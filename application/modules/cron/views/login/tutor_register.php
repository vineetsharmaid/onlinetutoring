  ...
  <div class="login-container bg-white">
    <div class="p-l-50 m-l-20 p-r-50 m-r-20 p-t-50 p-b-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
      <div class="col-sm-12 col-sm-height col-middle">
        <a href="<?=base_url()?>"><img src="<?=base_url()?>assets/img/logo.png" alt="logo" data-src="<?=base_url()?>assets/img/logo.png" data-src-retina="<?=base_url()?>assets/img/logo_2x.png" width="195"></a>
