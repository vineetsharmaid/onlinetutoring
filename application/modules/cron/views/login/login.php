    <div class="login-wrapper">
      ...
      <div class="login-container bg-white">
        ...
        <a href="<?=base_url()?>">
          <img src="<?=base_url()?>assets/img/logo.png" alt="logo" data-src="<?=base_url()?>assets/img/logo.png" data-src-retina="<?=base_url()?>assets/img/logo_2x.png" width="195">
        </a>
          ...
          <form id="form-login" class="p-t-15 auth-form" role="form" name="loginForm" ng-submit="submitForm()" novalidate ng-cloak ng-hide="forgetSection">
            ...
            <div class="row">
              ...
              <div class="col-md-6 text-right">
                <a href="#" class="text-info small" ng-click="forgetShow()">Forget your Password/Email?</a>
              </div>
            </div>
