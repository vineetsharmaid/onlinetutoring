  ...
  <div class="login-container bg-white">
    <div class="p-l-50 m-l-20 p-r-50 m-r-20 p-t-50 p-b-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
      <div class="col-lg-12 col-middle">
        <a href="<?=base_url()?>">
          <img src="<?=base_url()?>assets/img/logo.png" alt="logo" data-src="<?=base_url()?>assets/img/logo.png" data-src-retina="assets/img/logo_2x.png" width="195">
        </a>
        ...
        <form id="student-register" class="p-t-15 auth-form" name="studentRegisterForm" ng-submit="registerStudent()" novalidate ng-cloak >
          ...
          <div class="row">
            <div class="col-sm-6 p-b-10">
              <div class="form-group form-group-default" ng-class="{has_errors:studentRegisterForm.city.$dirty && studentRegisterForm.city.$error.required}">
                <label>City/Town</label>
                <input type="text" ng-model="User.city" name="city" placeholder="Ex: Chandigarh, India " class="form-control" required>
              </div>
