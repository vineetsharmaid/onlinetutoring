  ...
  <div class="row border-bottom">
    ...
    <div class="col-sm-6 col-md-3">
      <div class="widget dark mt-30">
        ...
        <form class="newsletter-form" id="mailchimp-subscription-form-footer" novalidate="true">
          <div class="input-group">
            <input type="email" id="mce-EMAIL-footer" data-height="40px" class="form-control input-lg font-14" placeholder="Your Email" name="EMAIL" value="" style="height: 40px;">
