    ...
    <script src="<?=base_url()?>assets/angular/admin/login.app.js"></script>
    ...
    <script type="text/javascript" src="http://iamrohit.in/lab/js/locationv1.js"></script>
    <!-- END VENDOR JS -->
