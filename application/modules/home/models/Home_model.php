...
class Home_model extends CI_Model {
    ...
    $post_data['phonecode'] 		= '+'.$post_data['phonecode']['phonecode'];

    $register_data['firstname'] = $post_data['firstname'];
    $register_data['lastname']  = $post_data['lastname'];
    $register_data['email']     = $post_data['email'];
    $register_data['password']  = $hashed_password;
    $register_data['phonecode']	= $post_data['phonecode'];
    $register_data['phone']     = $post_data['phone'];
    $register_data['country']   = $post_data['country']['country_id'];
    $register_data['state']     = $post_data['state']['state_id'];
    $register_data['city']      = $post_data['city']['city_id'];
