            ...
            */   
            yearSelector.prototype.render = function(){
                ...
                for (var i = 1; i <= diffYears; i++) {
                    ...
                    Calendar.content += '<a data-href="#" class="year-selector ' + activeClass + '" data-year=' + yearInc + '>' + yearInc + '</a>';
            ...
            */
            render : function(){
                ...
                for (var i = 0; i < months.length; i++) {
                    ...
                    Calendar.content += '<a data-href="#" class="month-selector ' + activeClass + '" data-month="' + formatedMonth + '">' + formatedMonth + '</a>';
                    Calendar.content += '</div>';
                }
                $(this.container).append(Calendar.content);
                ...
                for (var i = 1; i <= Calendar.daysOfMonth; i++) {
                    ...
                    (t ==  weekStart || i == 1) ? Calendar.content += '<div class="week ' + activeClass + '">': '';
                        if(t >= weekStart && t <= weekEnd){
                            ...
                            Calendar.content += '<div class="day"><a data-href="#" data-date=' + date.format(Calendar.settings.ui.week.day.format) + '>' + i + '</a></div>';
                            Calendar.content += '</div>';
                            Calendar.content += '</div>';
                        }
        ...
        wView.prototype._bindEventDraggers = function() {
                ...
                .resizable({
                  ...
                  .on('resizeend', function (event) {
                    ...
                    days = 0;
                    Calendar.settings.events[eventData.index] = eventO;
                    plugin.settings.onEventResizeComplete(eventO);
                    $this._drawEvent();               
                  });       
        },
